...
def drop_correlated_features(
    ...
    # Добавляем target_col в exclude - гарантируем защиту
    ...
    imputer = Imputer(
        strategy='median',
        inputCols=feature_cols_valid,
        outputCols=feature_cols_valid
    )
    ...
    # Гарантированно исключаем target_col из дропа, если он есть в данных
    if target_col and target_col in features_to_drop:
